...
class Blowfish:
    ...
    Public functions:
        ...
        def __init__ (self, key)
            ...
            created, the key is no inter necessary.
    ...
    def __round_func (self, xl):
        ...
        # Perform all ops as ints then and out the last 32-bits to
        # obtain the integer
...
##############################################################
def test():
    cipher = Blowfish ("0123456789abcdef")
    cipher.initCTR()
    data = "x" *1024*100#100Kb of "x"
    a = time.time()
    cipher.encryptCTR(data)
    b = time.time()
    return 100/(b-a)
